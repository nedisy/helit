...
# Tests the dpgmm model by seeing how well it fits a mixture of 3 1D Gaussians, which is visualised using open CV. This version trys increasing the number of sticks until the model gets worse, at which point it stops.
